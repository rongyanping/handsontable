...
function EditorManager(instance, priv, selection) {
  ...
  function moveSelectionAfterEnter(shiftKey) {
    const enterMoves = typeof priv.settings.enterMoves === 'function' ? priv.settings.enterMoves() : priv.settings.enterMoves;
  ...
  function init() {
    ...
    // 下面的注释源码里面是放开的；若放开会影响快速点击单元格时调取hotInstance.getActiveEditor()的值获取的一直是双击前的值

...
TextEditor.prototype.createElements = function () {
  ...
  addClass(this.TEXTAREA, 'handsontableInput'); // 浮框里面的textarea
  ...
  addClass(this.TEXTAREA_PARENT, 'handsontableInputHolder'); // 最外层的浮框
...
TextEditor.prototype.refreshDimensions = function (force = false) {
  ...
  if ((colHeadersCount && this.instance.getSelectedLast() && this.instance.getSelectedLast()[0] === 0) ||
    (settings.fixedRowsBottom && this.instance.getSelectedLast() && this.instance.getSelectedLast()[0] === totalRowsCount - settings.fixedRowsBottom)) {
    editTop += 1;
  }

  if (this.instance.getSelectedLast() && this.instance.getSelectedLast()[1] === 0) {
    editLeft += 1;
  }
  ...
  this.textareaParentStyle.top = `${editTop}px`; // 设置编辑框位置ryp
